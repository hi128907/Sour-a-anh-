...
const TELEGRAM_API = `https://still-hat-1e87.ductham784.workers.dev/bot${process.env.8581345348:AAH0HJxhs1hJonuQ3ZiQBYo5JLsCRVlKeiU}`;
const CHAT_ID = process.env.-5011906253!; 
